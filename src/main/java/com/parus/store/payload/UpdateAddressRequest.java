...
@ApiModel(value = "Update Address payload", description = "Payload to add or update address of user")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class UpdateAddressRequest {
	...
	@ApiModelProperty(value = "User addressId", required = true, allowableValues = "NonEmpty String")
